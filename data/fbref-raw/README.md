...
### ⚠️ The passing page needs a special save

The passing page's pass columns (Cmp, KP, …) are **JS-populated after load**,
so an "HTML Only" save contains them EMPTY and those two terms fall back to
league baselines. To capture the rendered table, save the two passing pages as
**File → Save As… → format: "Web Page, Single File"** (Chrome; `.mhtml`).
...
| 2025/26 passing | **Single File (.mhtml)** | https://fbref.com/en/comps/9/2025-2026/passing/2025-2026-Premier-League-Stats |
...
| 2024/25 passing | **Single File (.mhtml)** | https://fbref.com/en/comps/9/2024-2025/passing/2024-2025-Premier-League-Stats |
